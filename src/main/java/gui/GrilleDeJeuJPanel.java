...
public class GrilleDeJeuJPanel extends JPanel {
	...
	public static final int TAILLE_GRILLE = 10; // Taille des lignes et colonnes
												// de la grille.
	...
	public JLabel[] intitule_ligne = new JLabel[TAILLE_GRILLE]; // Intitulé des
																// lignes.
	...
	public void initAttribut() {
		grille = new CaseJButton[TAILLE_GRILLE][TAILLE_GRILLE]; // Initialisation
																// du tableau de
																// CaseJButton.
